...
namespace Espace.Gameplay.Empires
{
    ...
    public static class AIDecisionMaker
    {
        ...
        /// Photographie de la situation, calculee une fois par mois par
        /// <see cref="EmpireAssessmentFactory"/> et partagee avec les quatre autres modules de
        /// decision. Elle etait auparavant recalculee ici, et nulle part ailleurs.
        /// </param>
        public static void DecideAndAct(Empire empire, GalaxyMap map, IEconomyService economy, EmpireAssessment assessment)
        {
